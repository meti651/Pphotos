...
const Slider = () => {
  ...
  const images = useStaticQuery(graphql`
    {
      first: file(relativePath: { eq: "slider/1.jpg" }) {
        relativePath
        childImageSharp {
      ...
      second: file(relativePath: { eq: "slider/2.jpg" }) {
        relativePath
        childImageSharp {
          fluid(maxWidth: 1920, quality: 90) {
            ...GatsbyImageSharpFluid
      ...
      third: file(relativePath: { eq: "slider/3.jpg" }) {
        relativePath
        childImageSharp {
          fluid(maxWidth: 1920, quality: 90) {
            ...GatsbyImageSharpFluid
      ...
      fourth: file(relativePath: { eq: "slider/4.jpg" }) {
        relativePath
        childImageSharp {
          fluid(maxWidth: 1920, quality: 90) {
            ...GatsbyImageSharpFluid
      ...
      fifth: file(relativePath: { eq: "slider/5.jpg" }) {
        relativePath
        childImageSharp {
          fluid(maxWidth: 1920, quality: 90) {
            ...GatsbyImageSharpFluid
      ...
      sixth: file(relativePath: { eq: "slider/6.jpg" }) {
        relativePath
        childImageSharp {
          fluid(maxWidth: 1920, quality: 90) {
            ...GatsbyImageSharpFluid
  ...
  const slidesElements = [
    ...
    { image: images.fifth, caption: "páros/jegyes" },
  ...
  return (
    <>
      <div id={Styles.container}>
        {slidesElements.map((image, index) => (
          <Slide key={index} image={image} slide={slide} />
        ))}
      </div>
