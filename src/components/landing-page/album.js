		...
		<div id={Styles.container}>
			...
			<div id={Styles.description}>
				<div id={Styles.paragraph}>
					<p>
						Ha szeretnéd emlékeidet kézzelfoghatóvá tenni, nálam minden szolgáltatás igénybevétele után lehetőség van
						erre,fotóalbum formájában.
					</p>
					<p>
						Az albumokat minden esetben egyediség jellemzi, én készítem őket egy album szerkesztő szoftver segítségével.
					</p>
			...
			<div id={Styles.prices}>
				...
				<div className={Styles.pack}>
					...
					<div className={Styles.description}>
						...
						szeretnének, amit mindenki garantáltan megnéz!{" "}
					</div>
