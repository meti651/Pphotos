		...
		<div id={Styles.container}>
			<Helmet>
				<script
					...
					src="https://connect.facebook.net/hu_HU/sdk.js#xfbml=1&version=v9.0"
					nonce="vvneLWMJ"
				></script>
			</Helmet>
			<div
				className={`${Styles.facebook_container} fb-page`}
				data-href="https://www.facebook.com/pphotosofficial"
				data-tabs=""
				data-width="500"
				data-height=""
			...
			<div id={Styles.text}>
				...
				<p>
					Bármilyen kérdésre, ötletre szívesen válaszolok, a közösségi oldalaimra pedig megéri benézni, hiszen sok új
					tartalmat töltök fel heti szinten.
				</p>
