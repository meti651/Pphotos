		...
		<div id={Styles.container}>
			...
			<div id={Styles.second_part}>
				<div className={Styles.image_wrapper}>
					<div className={Styles.blur_border}>
						<div
							...
							style={{ width: `${images.content1.childImageSharp.fluid.aspectRatio * 350 * imageWidthProportion}px` }}
						>
				...
				<div className={Styles.image_wrapper}>
					<div className={Styles.blur_border}>
						<div
							className={Styles.image}
							style={{ width: `${images.content2.childImageSharp.fluid.aspectRatio * 350 * imageWidthProportion}px` }}
						>
			...
			<div id={Styles.third_part}>
				<div className={Styles.image_wrapper}>
					<div className={Styles.blur_border}>
						<div
							className={Styles.image}
							style={{
								width: `${images.content3.childImageSharp.fluid.aspectRatio * 700 * (1 / imageWidthProportion)}px`,
								maxWidth: "80vw",
							}}
						>
				...
				<div className={Styles.text}>
					<div id={Styles.top}>
						<p>
							Kizárólag minőségi, szerkesztett fotókat adok át Nektek. Csak olyan képet adok ki a kezemből, amilyet én
							is látni szeretnék.
						</p>
						<p>
							Az esküvő után pedig ezek a képek emlékeztetnek majd Titeket a napra, amikor kimondtátok azt a bizonyos
							igent.
						</p>
					</div>
					<p id={Styles.bottom}>
						Szeretném, ha a képeket nézegetve azt éreznétek, mintha épp az esküvőtökön lennétek, hogy újra átélhessétek
						a legszebb pillanatokat családotok, szeretteitek körében, és majd büszkén mutathassátok akár
						gyermekeiteknek.
					</p>
				</div>
			</div>
			<p>
				<strong>
					Szeretettel várlak Titeket, s megtiszteltek vele, ha életetek egyik legszebb napját én örökíthetem meg.
				</strong>
			</p>
			<div id={Styles.photo_given}>
				<h2>Képátadás 2 héten belül</h2>
				<p>
					Mivel tudom, hogy izgatottan várjátok a képeket, ezért az{" "}
					<strong>esküvőt követő másnapon már elküldök nektek 5db retusált fotót</strong>, hogy ne a telefonos képeket
					kelljen nézegetni, és legyen lehetőség akár már másnap profi képet megosztani.
				</p>
			</div>
		</div>
	);
