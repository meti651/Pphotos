      ...
      <div id={Styles.packages}>
        ...
        <div className={Styles.wedding_package} id={Styles.diamond}>
          ...
          <ul>
            ...
            <li>Csoportképek</li>
            <li>
              Kreatív fotózás + fotózás másik napon is választott
              helyszínen/jegyesfotózás (Kb. 1-2 óra) Budapest vonzáskörzetében.
              (Vidék esetén választható más extra szolgáltatás)
            </li>
            <li>
              Egész Lagzi fotózása hajnali 01:00-ig (táncok, party, játékok,
              tortavágás)
            </li>
            <li>Kb. 11 óra rendelkezésre állás</li>
            <li>Kb. 500db retusált kép</li>
            <li>30db prémium előhívatott fotó</li>
            <li>
              <a href={`#${AlbumStyles.container}`}>Fotóalbum</a> (A4 prémium)
            </li>
