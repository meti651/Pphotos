			...
			<div id={Styles.packages}>
				...
				<div className={Styles.package} id={Styles.diamond}>
					...
					<ul>
						...
						<li>Csoportképek</li>
						<li>
							Kreatív fotózás + fotózás másik napon is választott helyszínen/jegyesfotózás (Kb. 1-2 óra) Budapest
							vonzáskörzetében. (Vidék esetén választható más extra szolgáltatás)
						</li>
						...
						<li>
							<a href={`#${AlbumStyles.container}`}>Fotóalbum</a> (Extra nagy)
						</li>
