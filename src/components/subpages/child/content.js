        ...
        <div id={Styles.container}>
            ...
            <div id={Styles.first_part}>
                ...
                <div className={Styles.image_container} id={Styles.grid2}>
                    <div className={Styles.blur_border} style={{width: `${images.second.childImageSharp.fluid.aspectRatio * 750 * imageWidthProportion}px`}}>
            ...
            <div className={Styles.image_container} >
                <div className={Styles.blur_border} style={{width: `${images.third.childImageSharp.fluid.aspectRatio * 450 * imageWidthProportion}px`}}>
            ...
            <div className={Styles.image_container} id={Styles.narrow_image}>
                <div className={Styles.blur_border} style={{width: `${images.fourth.childImageSharp.fluid.aspectRatio * 450 * imageWidthProportion}px`}}>
